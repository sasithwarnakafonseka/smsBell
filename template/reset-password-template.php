...
if(!headers_sent())
		...
		echo'								<div class="mo_customer_validation-login-container">
												<form name="f" method="post" action="">
													<input type="hidden" name="option" value="Websms-change-password-form" />
													<label>New password</label>
													<input type="password" name="Websms_user_newpwd"  autofocus="true" placeholder="" id="Websms_user_pwd" required="true" title="Enter Your New password" />
													
													<label>Confirm password</label>
													<input type="password" name="Websms_user_cnfpwd"  autofocus="true" placeholder="" id="Websms_user_cnfpwd" required="true" title="Confirm password" />
													
													<br /><input type="submit" name="Websms_reset_password_btn" id="Websms_reset_password_btn" class="miniorange_otp_token_submit" value="'.__("Change Password").'" />
