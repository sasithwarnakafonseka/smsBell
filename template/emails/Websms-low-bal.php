                ...
                <td align="center" style="padding-top:30px;padding-bottom:30px;">
                    <table align="center" style="max-width:475px;width:100%" border="0" cellspacing="0" cellpadding="0">
                        <tbody>
                                                                ...
                                                                <td align="center" style="padding-top:10px;padding-bottom:17px">
                                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <center><a href="https://www.Websms.co.in/#pricebox" style="background:#03a9f4;border-radius:3px;color:#ffffff;display:block;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;letter-spacing:1px;padding:14px 8px;text-decoration:none" target="_blank">BUY CREDIT </a></center>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                            ...
                            <tr>
                                <td bgcolor="#fafafa" align="center" style="padding:25px 20px;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;font-size:12px;line-height:16px;color:#9fb1c1"><img alt="smsBell" src="https://www.Websms.co.in/logo/www.Websms.co.in.png" style="padding-bottom:20px;" width="120">
                                    <br><a style="color:#9fb1c1;font-family:Roboto,Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:normal;text-decoration:none"> &copy; 2017 www.Websms.co.in. a venture of www.cozyvision.com, 1023, The Ithum Tower-B Plot No. A-40, Sector-62, Noida Uttar Pradesh - 201301</a></td>
                            </tr>
                        </tbody>
                    </table>
                </td>
